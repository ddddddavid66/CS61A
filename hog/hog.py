...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def startegy(score, opponent_score):
        return n
    return startegy
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    count,num,first = 2,1,make_averaged(roll_dice, times_called)(1,dice)
    while count <= 10:
        temp = make_averaged(roll_dice, times_called)(count,dice)
        if  temp > first:
            num = count
            first = temp
        count += 1
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    return 0 if score >= threshold else num_rolls
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    cnt = 1
    while cnt <= 3:
        if sus_update(cnt,score, opponent_score) >= GOAL:
            return cnt
        cnt += 1
    return 6 if make_averaged(roll_dice,100)(6,six_sided) > (sus_update(0, score, opponent_score) - score) else 0
    # END PROBLEM 12
